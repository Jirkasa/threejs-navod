...
iExample.onInit = () => {
    ...
    progressBar.style.width = "calc(100% - 6.4rem)";
    progressBar.style.height = "3.2rem";
    progressBar.style.backgroundColor = "#646C6D";

    overlay.appendChild(progressBar);

    // progress bar track
    let progressBarTrack = document.createElement("div");
    progressBarTrack.style.height = "100%";
    progressBarTrack.style.width = "0%";
    progressBarTrack.style.backgroundColor = "#78E8FA";

    progressBar.appendChild(progressBarTrack);
