...
const setFullscreen = () => {
    iExample.canvas.requestFullscreen();
}
...
iExample.onPlay = () => {
    iExample.canvas.addEventListener("dblclick", setFullscreen);
}

iExample.onReset = () => {
    iExample.canvas.removeEventListener("dblclick", setFullscreen);
}
...
iExample.onResize = () => {
    if (document.fullscreenElement) {
        ...
        iExample.renderer.setSize(window.innerWidth, window.innerHeight);
    }
}
