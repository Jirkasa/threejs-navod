...
iExample.onPlay = () => {
    ...
    controls = new PointerLockControls(camera, iExample.canvasContainer);
    iExample.canvas.addEventListener("click", onClick);
...
iExample.onReset = () => {
    ...
    iExample.canvas.removeEventListener("click", onClick);
